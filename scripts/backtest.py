...
from pickles.backtester.engine import Backtester
from pickles.backtester.metrics import compute_metrics
from pickles.backtester.report import generate_tearsheet
from pickles.data.historical import load_universe
from pickles.strategies import MomentumStrategy, MeanReversionStrategy
from pickles.strategies.pairs import PairsStrategy
from pickles.utils.logger import setup_logging
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Pickles backtester")
